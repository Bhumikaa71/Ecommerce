...
function MarketPlace() {
  return (
    <div className='p-4 mt-10'>
        <div>
            <h1 className='font-bold text-2xl'>Swoo – #1 Online Marketplace for technology</h1>
        </div>
        <p className='text-xl text-gray-500'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vitae posuere mi. Quisque iaculis dignissim scelerisque. Morbi condimentum sagittis leo vitae tempor.<br/>
...
Fusce mattis nec nulla in scelerisque.<br/><br/>

Morbi pharetra sem mauris, nec aliquet ipsum vestibulum suscipit. Curabitur non euismod dui. Proin eget justo eu erat luctus placerat. Nam rhoncus ipsum ac enim faucibus, at consequat<br/>
